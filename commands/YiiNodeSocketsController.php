...
class NodeSocketCommand extends \yii\console\Controller {
	...
	public function actionCompileConfig() {
	    $this->compileServer();
	    $this->compileClient();
    }
...
EOD;
	...
	protected function getComponent() {
        ...
        if(isset($this->backendIP)) {
            $nodeSocket->allowedServerAddresses[] = $this->backendIP;
            $nodeSocket->allowedServerAddresses[] = '::ffff:' . $this->backendIP;
        }
